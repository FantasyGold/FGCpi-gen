![fantasygoldpi](https://i.imgur.com/SilKhPO.png)

# FGCpi-gen

_Tool used to create fantasygold pi image, forked from official pi-gen the raspberrypi.org Raspbian images_

Wallet locations  
FantasyGold - QT - /usr/local/bin and /home/pi/FantasyGold  
fantasygoldd - daemon - /usr/local/bin  
...
| ------------- |:-------------:| -----:| -----:|
| fantasygold-lite      | fantasygoldd & FantasyGold QT | v2.0.0.0 | master |
| fantasygold      | fantasygoldd & FantasyGold QT | v2.0.0.0 | master |


## Build   
clone
```
git clone https://github.com/FantasyGold/FGCpi-gen
```
after cloning, make the fantasygold compile bash file(s) executable
```
cd ~/FGCpi-gen/stage2/04-fantasygoldd
chmod +x 04-run.sh
cd ~/FGCpi-gen/stage4/04-fantasygold
chmod +x 00-run.sh
```
...
cd ~/FGCpi-gen
```
To build **fantasygold-lite** - fantasygoldd daemon & QT (command line only)  
```
# Example for building fantasygold lite system
echo "IMG_NAME='fantasygold'" > config
touch ./stage3/SKIP ./stage4/SKIP ./stage5/SKIP
touch ./stage4/SKIP_IMAGES ./stage5/SKIP_IMAGES
sudo ./build.sh
```
To build **fantasygold-lite** + **fantasygold** - fantasygoldd daemon & QT (Full Deskstop)  
```
# Example for building fantasygold lite + full desktop system
echo "IMG_NAME='fantasygold'" > config
touch ./stage5/SKIP
sudo ./build.sh
```
...
vncserver
```
Connect with VNC Viewer using hostname or IP example ie, fantasygoldos:1 or 192.168.1.111:1  
## Config
